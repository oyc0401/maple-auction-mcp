...
export const SET_DB: Record<string, Record<number, SetTier>> = {
  ...
  '칠흑의 보스': {
    2: { allStat: 10, hp: 250, atk: 10, boss: 10 },
    3: { allStat: 10, hp: 250, atk: 10, ida: 10 },
    4: { allStat: 15, hp: 375, atk: 15, critDmg: 5 },
    5: { allStat: 15, hp: 375, atk: 15, boss: 10 },
    6: { allStat: 15, hp: 375, atk: 15, ida: 10 },
    7: { allStat: 15, hp: 375, atk: 15, critDmg: 5 },
    8: { allStat: 15, hp: 375, atk: 15, boss: 10 },
    9: { allStat: 15, hp: 375, atk: 15, critDmg: 5 },
    10: { allStat: 20, hp: 500, atk: 20, boss: 10 },
  },
  '보스 장신구': {
    3: { allStat: 10, atk: 5 },
    5: { allStat: 10, atk: 5 },
